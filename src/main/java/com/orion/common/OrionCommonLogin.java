...
public class OrionCommonLogin extends HttpServlet {

	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(OrionCommonLogin.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>Orion-Common</title>");
        out.println("</head>");
        out.println("<body>");
        out.println("<h1>Orion-Common - Completed Generating " + noOfErrors + " Errors ....</h1>");
        out.println("<br/><br/>");
